...
const movies = [
    ...
    {title: 'Peter Pan', explanation: 'In this movie some kids die and an angel escorts them to heaven...', hint: 'Always flying, cuz he never lands'},
...
guessbutton = () => {
  ...
  if(guess === ''){
    errorMsg.setAttribute('class', 'badge badge-warning'); 
    ...
    message.textContent = `Well done! ${rightMovie} is the right movie`;
    message.setAttribute('class', 'alert alert-success');
    guessBtn.innerHTML = 'Next Movie';
    ...
    message.textContent = `Sorry, ${guess} is not correct. Try again, you have ${guessesLeft} guesses left.`;
  }
